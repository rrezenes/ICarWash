...
public class SolicitacaoDAO {
    ...
    private static final String SELECT_BY_ID = "SELECT ID, id_cliente, id_lavador, id_avaliacao, id_modelo, data_solicitacao, valor_total, status FROM solicitacao where solicitacao.ID = ?";
