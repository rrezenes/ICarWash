...
<div class="container">
    ...
    <form id="ContinuarCadastro" action="ContinuarCadastro" method="post">
        <div class="form-group">
            ...
            <div class="row" class="col-md-offset-1 col-md-10">
                <div class="col-md-offset-1 col-md-7"><label>Endereço:</label> <input class="form-control erro-endereco" type="text" name="endereco" id="endereco"><br></div>
                <div class="col-md-3"><label>Número:</label> <input class="form-control erro-numero" type="text" name="numero" id="numero"><br></div>
            </div>   
        </div>
        <center>
