...
<html>
    ...
    <body>
                <div class="container" style="max-width: 1035.0px;">
        <div class="jumbotron">
                ...
                <form action="NovoCliente" method="post">
                    <div class="form-group">
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-6"><label>Celular:</label> <input class="form-control" type="text" name="telefone" id="telefone"><br></div>
                        </div>
                        <div class="row">
